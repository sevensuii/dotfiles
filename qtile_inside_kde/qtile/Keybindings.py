...
keys = [
    ...
    Key([mod], "space", lazy.spawn(home+"/git_repos/dotfiles/scripts/kb_layout_change"), desc="Next keyboard layout."),
    ...
    Key([], "XF86Launch3", lazy.spawn(os.path.expanduser(home+"/git_repos/dotfiles/scripts/rog_kb_menu")), desc="Keyboard RBG controll"),
    # Key(["mod1"], "w", lazy.spawn(os.path.expanduser(home+"/git_repos/dotfiles/scripts/wifi_menu")), desc="Launch Wi-fi menu script")]
]
