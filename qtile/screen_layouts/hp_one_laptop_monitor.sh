...
xrandr --output eDP-1 --mode 1920x1080 -r 60 --primary --pos 0x0 --rotate normal --output DP-1 --off --output DP-2 --off --output DP-3 --off --output DP-4 --off --output HDMI-1 --off
